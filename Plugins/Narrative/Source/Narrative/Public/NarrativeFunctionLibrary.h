...
public:
	...
	*/
	...
	static void PreDuplicateMarkedObjects(UObject* SourceObject, UObject* DestOuter, TMap<UObject*, UObject*>& DuplicationSeed);

	UObject* DeepDuplicateWithMeta(UObject* Root, UObject* DestOuter, FName DestName = NAME_None);
};
